...
$$
	\partial_{t} \rho + \nabla_x \cdot (v\rho) + \nabla_{v}\cdot(( b-v)\rho) - \Delta_{v}\rho = 0 \,.
$$
...
$$
	\partial_{t} \rho^\epsilon + \nabla_x \cdot (v\rho^\epsilon) + \epsilon^{-1}\nabla_{v}\cdot(( b-v)\rho^\epsilon) - \epsilon^{-1} \Delta_{v}\rho^\epsilon = 0 \,.
$$

. . .

- Use hypoellipticity to control $\nabla_x \rho^\epsilon$ and $\Delta_x \rho^\epsilon$
...
Pros: avoid using hypoellipticity

. . .

Cons: assume regularity of velocity field
