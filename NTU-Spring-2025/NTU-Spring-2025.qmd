...
Friedrichs:
  ...
  "Courant told me after the war that I should reach out to real scientists and not stay with mathematicians all the time."

. . .

Me (out of my ignorance) to a wise man:

  "I find it somewhat frustrating that physicists are often mathematically ambiguous but they also often reach the right conclusion."

. . .

The wise man to me:

  "A great fun challenge of going to a physics talk is to find some correct thing and work on it."


# Original motivation {background-color="#F5C946"}

##
<img data-src="images/NTU-Spring-2025/activecarpet.png"></img>
...
::: {.column width="60%"}
<img data-src="images/NTU-Spring-2025/carpet.png"></img>
:::

::: {.column width="40%"}
<img data-src="images/NTU-Spring-2025/profile.png"></img>
:::
...
<video
  data-autoplay
  loop
  src="images/NTU-Spring-2025/Guzman.mp4"
></video>


## Problem

- The authors of the paper consider passive tracers, whose distribution is described
  by advection-diffusion equation
  $$ \partial_t \rho + \nabla \cdot (\bf{v} \rho) = \kappa \Delta \rho $$
  $$ \nabla \cdot v = 0 $$

- Unverified assumption
<img data-src="images/NTU-Spring-2025/varyingD.png"></img>

## Question

How can one capture the non-uniformity in this system?
...
# It's been almost 50 years since the conjecture. Why should we believe such claim? {background-color="#F5C946"}
...
\begin{align*}
dZ^\epsilon_t 
&= b(Z^\epsilon_t,t) dt - \textcolor{red}{\epsilon} \left( \partial_t b(X^\epsilon_t,t) + Db(X^\epsilon_t,t) \, \dot X^\epsilon_t \right) dt 
+ \sqrt{2 \epsilon} dW_t \\
  &= F(Z^\epsilon_t,t) \, dt 
+ \sqrt{2 \epsilon} dW_t 
\end{align*}
